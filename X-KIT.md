...
**1/** (attach uohm-keyart.png)
Every chain gets a reserve currency. This one got the unicorn. 🦄
...
01 — Stake $uOHM → receive suOHM → rebase upward every epoch. Nothing to claim, the index only goes up.
02 — Bond ETH/USDC at a discount → the treasury deepens.
03 — (3,3). If everyone stakes, everyone wins.

**3/** (attach uohm-33.png)
The (3,3) game, unicorn edition.

Staking is cooperation. Bonding feeds the treasury. Selling is glue.
